                      ...
                      <tr>
                        ...
                        <td>
                            <form class="forms-sample" action="../../php/companyProfile/galleryCategoryActions.php" method="POST">
                                    <input type="text" class="form-control" name="id_gallery_category" hidden  value="<?php echo $row['id_gallery_category']; ?>"> 
                                    <button class="badge badge-danger" name="submitDeleteGalleryCategory">Delete</button>
                            </form>
                        </td>
                      </tr>
                    <?php } ?>
