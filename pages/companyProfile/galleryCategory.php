                        ...
                        <div class="col-md-4">
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" enctype="multipart/form-data" method="POST"
                                    action="../../php/companyProfile/galleryCategoryActions.php">
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary"
                                            name="submitInsertGalleryCategory">Submit</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
                                                ...
                                                <td>
                                                    <form class="forms-sample"
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="id_gallery_category" hidden
                                                            value="<?php echo $row['id_gallery_category']; ?>">
                                                        <button class="badge badge-danger"
                                                            name="submitDeleteGalleryCategory">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php } ?>
