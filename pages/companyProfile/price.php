                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" enctype="multipart/form-data" method="POST"
                                    action="../../php/companyProfile/priceActions.php">
                                    <div class="card-body">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="forms-sample"
                                                    action="../../php/companyProfile/priceActions.php" method="POST">
                                                    <input type="text" class="form-control" name="id" hidden
                                                        value="<?php echo $row['id_price']; ?>">
                                                    <button class="badge badge-danger"
                                                        name="submitDeletePrice">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php } ?>
