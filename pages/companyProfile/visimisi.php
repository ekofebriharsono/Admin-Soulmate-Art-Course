                                ...
                                <form role="form" method="POST" action="../../php/companyProfile/visiMisiActions.php">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary"
                                            name="submitInsertVisi">Submit</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" method="POST" action="../../php/companyProfile/visiMisiActions.php">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" class="btn btn-primary"
                                            name="submitInsertMisi">Submit</button>
                                    </div>
                                </form>
                            </div>
                            <!-- /.card -->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form class="forms-sample"
                                                        action="../../php/companyProfile/visiMisiActions.php"
                                                        method="POST">
                                                        <input type="text" class="form-control" name="id" hidden
                                                            value="<?php echo $row['id_visi']; ?>">
                                                        <button class="badge badge-danger"
                                                            name="submitDeleteVisi">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php } ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form class="forms-sample"
                                                        ...
                                                        method="POST">
                                                        <input type="text" class="form-control" name="id" hidden
                                                            value="<?php echo $row['id_misi']; ?>">
                                                        <button class="badge badge-danger"
                                                            name="submitDeleteMisi">Delete</button>
                                                    </form>
                                                </td>
                                            </tr>
                                            <?php } ?>
