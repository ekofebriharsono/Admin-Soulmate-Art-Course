                ...
                <form role="form" enctype="multipart/form-data" method="POST" action="../../php/companyProfile/galleryActions.php">
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="image_name" placeholder="Enter team name">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      ?>
                        <option value="<?php echo $row['id_gallery_category']; ?>"><?php echo $row['category_name']; ?></option>
                      <?php } ?>
                      </select>
                    </div>
                    <div class="form-group">
                      ...
                      <tr>
                        ...
                        <td>
                            <form class="forms-sample" action="../../php/companyProfile/galleryActions.php" method="POST">
                                    ...
                                    <button class="badge badge-danger" name="submitDeleteGallery">Delete</button>
                            </form>
                        </td>
                      </tr>
                    <?php } ?>
