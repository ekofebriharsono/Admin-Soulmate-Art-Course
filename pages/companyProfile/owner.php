                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" enctype="multipart/form-data" method="POST"
                                    action="../../php/companyProfile/ownerActions.php">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="label_owner"
                                                placeholder="Enter label owner">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Owner Description</label>
                                            <input type="text" class="form-control" name="owner_descriptions"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="forms-sample"
                                                    action="../../php/companyProfile/ownerActions.php" method="POST">
                                                    <input type="text" class="form-control" name="id" hidden
                                                        value="<?php echo $row['id_owner']; ?>">
                                                    <button class="badge badge-danger"
                                                        name="submitDeleteOwner">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php } ?>
