                ...
                <form role="form" method="POST" action="../../php/companyProfile/contactUsActions.php">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="call_us" placeholder="Enter call us">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="link_ig" placeholder="Enter link instagram">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Link Youtube</label>
                      <input type="text" class="form-control" name="link_yt" placeholder="Enter link youtube">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Link WhatsApp</label>
                      <input type="text" class="form-control" name="link_wa" placeholder="Enter link whatsapp">
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">Link Telegram</label>
                      <input type="text" class="form-control" name="link_tl" placeholder="Enter link telegram">
                    </div>
                  </div>
                  <!-- /.card-body -->
                      ...
                      <tr>
                        ...
                        <td>
                          <form class="forms-sample" action="../../php/companyProfile/contactUsActions.php" method="POST">
                                  ...
                                  <button class="badge badge-danger" name="submitDeleteContactUs">Delete</button>
                          </form>
                        </td>
                      </tr>
                    <?php } ?>
