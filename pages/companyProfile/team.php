                                            ...
                                            <tbody>
                                                <?php while ($row = mysqli_fetch_array($res)) { ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo formatText50($row['team_descriptions']); ?></td>
                                                        <td>
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form role="form" enctype="multipart/form-data" method="POST" action="../../php/companyProfile/teamActions.php">
                                                                        <div class="card-body">
                                                                        <div class="form-group">
                                                                                <label for="exampleInputEmail1">Id Team</label>
                                                                                <input type="text" class="form-control" name="id" placeholder="Enter team name" value="<?php echo $row['id_team']; ?>" required readonly>
                                                                            </div>
                                                                            <div class="form-group">
                                                                                <label for="exampleInputEmail1">Team Name</label>
                                                                        ...
                                                                        <div class="card-footer">
                                                                            <button type="submit" class="btn btn-primary" name="submitUpdateTeam">Save Changes</button>
                                                                        </div>
                                                                    </form>
                                                                </div>
