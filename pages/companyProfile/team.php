                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary">
                                ...
                                <form role="form" enctype="multipart/form-data" method="POST"
                                    action="../../php/companyProfile/teamActions.php">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="label_team"
                                                placeholder="Enter label team">
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Team Description</label>
                                            <input type="text" class="form-control" name="team_descriptions"
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form class="forms-sample"
                                                    action="../../php/companyProfile/teamActions.php" method="POST">
                                                    <input type="text" class="form-control" name="id" hidden
                                                        value="<?php echo $row['id_team']; ?>">
                                                    <button class="badge badge-danger"
                                                        name="submitDeleteTeam">Delete</button>
                                                </form>
                                            </td>
                                        </tr>
                                        <?php } ?>
